...
func init() {
	...
	rootCmd.PersistentFlags().BoolP("keepports", "k", false, "Open up portforward on same port as target port")
	...
	viper.BindPFlag("kubernetes.keepports", rootCmd.PersistentFlags().Lookup("keepports"))
